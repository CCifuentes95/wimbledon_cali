...
public class PaisLogic implements IPaisLogic {
    ...
    */
    ...
    public void savePais(Pais entity) throws Exception {
        ...
        try {
            if (entity.getCodigopais() == null) {
                throw new ZMessManager().new EmptyFieldException("codigopais");
            }
            ...
            if (getPais(entity.getCodigopais()) != null) {
    ...
    public void deletePais(Pais entity) throws Exception {
        ...
        try {
            jugadors = jugadorDAO.findByProperty("pais.codigopais",
    ...
    public List<PaisDTO> getDataPais() throws Exception {
        try {
            ...
            for (Pais paisTmp : pais) {
                ...
                paisDTO2.setCodigopais(paisTmp.getCodigopais());
                paisDTO2.setNombre((paisTmp.getNombre() != null)
                    ? paisTmp.getNombre() : null);
    ...
    public Pais getPais(Long codigopais) throws Exception {
        ...
        try {
            entity = paisDAO.findById(codigopais);
        } catch (Exception e) {
