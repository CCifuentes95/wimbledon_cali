...
public class EquipoLogic implements IEquipoLogic {
    private static final Logger log = LoggerFactory.getLogger(EquipoLogic.class);
    ...
    */
    ...
    public void saveEquipo(Equipo entity) throws Exception {
        ...
        try {
            ...
            if (entity.getCodigoequipo() == null) {
                throw new ZMessManager().new EmptyFieldException("codigoequipo");
            }
            ...
            if (getEquipo(entity.getCodigoequipo()) != null) {
    ...
    public List<EquipoDTO> getDataEquipo() throws Exception {
        try {
            ...
            for (Equipo equipoTmp : equipo) {
                ...
                equipoDTO2.setCodigoequipo(equipoTmp.getCodigoequipo());
                equipoDTO2.setNombre((equipoTmp.getNombre() != null)
                    ? equipoTmp.getNombre() : null);
                equipoDTO2.setCodigojugador_Jugador((equipoTmp.getJugador()
                                                              .getCodigojugador() != null)
                    ? equipoTmp.getJugador().getCodigojugador() : null);
    ...
    public Equipo getEquipo(Long codigoequipo) throws Exception {
        ...
        try {
            entity = equipoDAO.findById(codigoequipo);
        } catch (Exception e) {
