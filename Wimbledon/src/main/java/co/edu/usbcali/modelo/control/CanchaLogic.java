...
public class CanchaLogic implements ICanchaLogic {
    ...
    */
    ...
    public void saveCancha(Cancha entity) throws Exception {
        ...
        try {
            if (entity.getCodigocancha() == null) {
                throw new ZMessManager().new EmptyFieldException("codigocancha");
            }

            if (entity.getDiametro() == null) {
                throw new ZMessManager().new EmptyFieldException("diametro");
            }

            if ((entity.getDiametro() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getDiametro(), 255) == false)) {
                throw new ZMessManager().new NotValidFormatException("diametro");
            }
            ...
            if (getCancha(entity.getCodigocancha()) != null) {
    ...
    public void deleteCancha(Cancha entity) throws Exception {
        ...
        try {
            partidos = partidoDAO.findByProperty("cancha.codigocancha",
                    entity.getCodigocancha());
    ...
    public List<CanchaDTO> getDataCancha() throws Exception {
        try {
            ...
            for (Cancha canchaTmp : cancha) {
                ...
                canchaDTO2.setCodigocancha(canchaTmp.getCodigocancha());
                canchaDTO2.setDiametro((canchaTmp.getDiametro() != null)
                    ? canchaTmp.getDiametro() : null);
                canchaDTO2.setDireccion((canchaTmp.getDireccion() != null)
                    ? canchaTmp.getDireccion() : null);
    ...
    public Cancha getCancha(Long codigocancha) throws Exception {
        ...
        try {
            entity = canchaDAO.findById(codigocancha);
        } catch (Exception e) {
